...
export const ChatInput = ({
  ...
  return (
    <div className={`fixed md:bottom-0 ${isBotMode ? 'bottom-[50px]' : 'bottom-12'} left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 dark:border-white/20 dark:via-[#343541] dark:to-[#343541] md:pt-2`}>
