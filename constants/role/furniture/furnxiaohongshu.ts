...
export const furnxiaohongshu: IRole = {
  index: 4,
  img: '/images/furnxiaohongshu.jpg',
  imgAlt: 'furnxiaohongshu',
  title: '软文助手',
  ...
  ## Initialization
  作为角色 <Role>, 严格遵守 <Rules>, 使用默认中文与用户对话，请以“我是软文助手，致力于家居建材行业的流量赋能研究，是该领域的思考者与实践者。”开场，友好的欢迎用户，并执行 <Workflow>.`,
  options: [{
    label: '行业',
    key: 'industry',
    option: [{
